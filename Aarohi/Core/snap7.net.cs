...
namespace Aarohi.Core
{
    ...
    public class S7MultiVar
    {
        ...
        public bool Add<T>(int Area, int WordLen, int DBNumber, int Start, int Amount, ref T[] Buffer, int Offset)
        {
            if (Count < S7Client.MaxVars)
            {
                ...
                if (nint.Size == 4)
                    Items[Count].pData = handle.AddrOfPinnedObject().ToInt32() + Offset * Marshal.SizeOf(typeof(T));
                else
                    Items[Count].pData = (nint)(handle.AddrOfPinnedObject().ToInt64() + Offset * Marshal.SizeOf(typeof(T)));
    ...
    public class S7Client
    {
        ...
        protected static extern nint Cli_Create();
        public S7Client()
        {
            Client = Cli_Create();
        }
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_Destroy(ref nint Client);
        ~S7Client()
        {
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_Connect(nint Client);
        public int Connect()
        {
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_ConnectTo(nint Client,
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_SetConnectionParams(nint Client,
            [MarshalAs(UnmanagedType.LPStr)] string Address,
            ushort LocalTSAP,
            ushort RemoteTSAP
            );
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_SetConnectionType(nint Client, ushort ConnectionType);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_Disconnect(nint Client);
        ...
        protected static extern int Cli_GetParam_i16(nint Client, int ParamNumber, ref short IntValue);
        ...
        [DllImport(S7Consts.Snap7LibName, EntryPoint = "Cli_GetParam")]
        protected static extern int Cli_GetParam_u16(nint Client, int ParamNumber, ref ushort IntValue);
        ...
        [DllImport(S7Consts.Snap7LibName, EntryPoint = "Cli_GetParam")]
        protected static extern int Cli_GetParam_i32(nint Client, int ParamNumber, ref int IntValue);
        ...
        [DllImport(S7Consts.Snap7LibName, EntryPoint = "Cli_GetParam")]
        protected static extern int Cli_GetParam_u32(nint Client, int ParamNumber, ref uint IntValue);
        ...
        [DllImport(S7Consts.Snap7LibName, EntryPoint = "Cli_GetParam")]
        protected static extern int Cli_GetParam_i64(nint Client, int ParamNumber, ref long IntValue);
        ...
        [DllImport(S7Consts.Snap7LibName, EntryPoint = "Cli_GetParam")]
        protected static extern int Cli_GetParam_u64(nint Client, int ParamNumber, ref ulong IntValue);
        ...
        protected static extern int Cli_SetParam_i16(nint Client, int ParamNumber, ref short IntValue);
        ...
        [DllImport(S7Consts.Snap7LibName, EntryPoint = "Cli_SetParam")]
        protected static extern int Cli_SetParam_u16(nint Client, int ParamNumber, ref ushort IntValue);
        ...
        [DllImport(S7Consts.Snap7LibName, EntryPoint = "Cli_SetParam")]
        protected static extern int Cli_SetParam_i32(nint Client, int ParamNumber, ref int IntValue);
        ...
        [DllImport(S7Consts.Snap7LibName, EntryPoint = "Cli_SetParam")]
        protected static extern int Cli_SetParam_u32(nint Client, int ParamNumber, ref uint IntValue);
        ...
        [DllImport(S7Consts.Snap7LibName, EntryPoint = "Cli_SetParam")]
        protected static extern int Cli_SetParam_i64(nint Client, int ParamNumber, ref long IntValue);
        ...
        [DllImport(S7Consts.Snap7LibName, EntryPoint = "Cli_SetParam")]
        protected static extern int Cli_SetParam_u64(nint Client, int ParamNumber, ref ulong IntValue);
        public int SetParam(int ParamNumber, ref ulong IntValue)
        {
            return Cli_SetParam_u64(Client, ParamNumber, ref IntValue);
        }

        public delegate void S7CliCompletion(nint usrPtr, int opCode, int opResult);

        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_SetAsCallback(nint Client, S7CliCompletion Completion, nint usrPtr);
        public int SetAsCallBack(S7CliCompletion Completion, nint usrPtr)
        {
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_ReadArea(nint Client, int Area, int DBNumber, int Start, int Amount, int WordLen, byte[] Buffer);
        ...
        protected static extern int Cli_ReadArea_ptr(nint Client, int Area, int DBNumber, int Start, int Amount, int WordLen, nint Pointer);
        public int ReadArea(int Area, int DBNumber, int Start, int Amount, int WordLen, nint Pointer)
        {
            return Cli_ReadArea_ptr(Client, Area, DBNumber, Start, Amount, WordLen, Pointer);
        }

        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_WriteArea(nint Client, int Area, int DBNumber, int Start, int Amount, int WordLen, byte[] Buffer);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_ReadMultiVars(nint Client, ref S7DataItem Item, int ItemsCount);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_WriteMultiVars(nint Client, ref S7DataItem Item, int ItemsCount);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_DBRead(nint Client, int DBNumber, int Start, int Size, byte[] Buffer);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_DBWrite(nint Client, int DBNumber, int Start, int Size, byte[] Buffer);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_MBRead(nint Client, int Start, int Size, byte[] Buffer);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_MBWrite(nint Client, int Start, int Size, byte[] Buffer);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_EBRead(nint Client, int Start, int Size, byte[] Buffer);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_EBWrite(nint Client, int Start, int Size, byte[] Buffer);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_ABRead(nint Client, int Start, int Size, byte[] Buffer);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_ABWrite(nint Client, int Start, int Size, byte[] Buffer);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_TMRead(nint Client, int Start, int Amount, ushort[] Buffer);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_TMWrite(nint Client, int Start, int Amount, ushort[] Buffer);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_CTRead(nint Client, int Start, int Amount, ushort[] Buffer);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_CTWrite(nint Client, int Start, int Amount, ushort[] Buffer);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_ListBlocks(nint Client, ref S7BlocksList List);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_GetAgBlockInfo(nint Client, int BlockType, int BlockNum, ref US7BlockInfo Info);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_GetPgBlockInfo(nint Client, ref US7BlockInfo Info, byte[] Buffer, int Size);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_ListBlocksOfType(nint Client, int BlockType, ushort[] List, ref int ItemsCount);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_Upload(nint Client, int BlockType, int BlockNum, byte[] UsrData, ref int Size);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_FullUpload(nint Client, int BlockType, int BlockNum, byte[] UsrData, ref int Size);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_Download(nint Client, int BlockNum, byte[] UsrData, int Size);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_Delete(nint Client, int BlockType, int BlockNum);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_DBGet(nint Client, int DBNumber, byte[] UsrData, ref int Size);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_DBFill(nint Client, int DBNumber, int FillChar);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_GetPlcDateTime(nint Client, ref cpp_tm tm);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_SetPlcDateTime(nint Client, ref cpp_tm tm);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_SetPlcSystemDateTime(nint Client);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_GetOrderCode(nint Client, ref US7OrderCode Info);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_GetCpuInfo(nint Client, ref US7CpuInfo Info);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_GetCpInfo(nint Client, ref S7CpInfo Info);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_ReadSZL(nint Client, int ID, int Index, ref S7SZL Data, ref int Size);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_ReadSZLList(nint Client, ref S7SZLList List, ref int ItemsCount);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_PlcHotStart(nint Client);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_PlcColdStart(nint Client);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_PlcStop(nint Client);
        public int PlcStop()
        {
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_CopyRamToRom(nint Client, uint Timeout);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_Compress(nint Client, uint Timeout);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_GetPlcStatus(nint Client, ref int Status);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_GetProtection(nint Client, ref S7Protection Protection);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_SetSessionPassword(nint Client, [MarshalAs(UnmanagedType.LPStr)] string Password);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_ClearSessionPassword(nint Client);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_IsoExchangeBuffer(nint Client, byte[] Buffer, ref int Size);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_AsReadArea(nint Client, int Area, int DBNumber, int Start, int Amount, int WordLen, byte[] Buffer);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_AsWriteArea(nint Client, int Area, int DBNumber, int Start, int Amount, int WordLen, byte[] Buffer);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_AsDBRead(nint Client, int DBNumber, int Start, int Size, byte[] Buffer);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_AsDBWrite(nint Client, int DBNumber, int Start, int Size, byte[] Buffer);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_AsMBRead(nint Client, int Start, int Size, byte[] Buffer);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_AsMBWrite(nint Client, int Start, int Size, byte[] Buffer);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_AsEBRead(nint Client, int Start, int Size, byte[] Buffer);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_AsEBWrite(nint Client, int Start, int Size, byte[] Buffer);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_AsABRead(nint Client, int Start, int Size, byte[] Buffer);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_AsABWrite(nint Client, int Start, int Size, byte[] Buffer);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_AsTMRead(nint Client, int Start, int Amount, ushort[] Buffer);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_AsTMWrite(nint Client, int Start, int Amount, ushort[] Buffer);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_AsCTRead(nint Client, int Start, int Amount, ushort[] Buffer);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_AsCTWrite(nint Client, int Start, int Amount, ushort[] Buffer);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_AsListBlocksOfType(nint Client, int BlockType, ushort[] List);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_AsReadSZL(nint Client, int ID, int Index, ref S7SZL Data, ref int Size);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_AsReadSZLList(nint Client, ref S7SZLList List, ref int ItemsCount);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_AsUpload(nint Client, int BlockType, int BlockNum, byte[] UsrData, ref int Size);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_AsFullUpload(nint Client, int BlockType, int BlockNum, byte[] UsrData, ref int Size);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_AsDownload(nint Client, int BlockNum, byte[] UsrData, int Size);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_AsPlcCopyRamToRom(nint Client, uint Timeout);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_AsPlcCompress(nint Client, uint Timeout);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_AsDBGet(nint Client, int DBNumber, byte[] UsrData, ref int Size);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_AsDBFill(nint Client, int DBNumber, int FillChar);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_CheckAsCompletion(nint Client, ref int opResult);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_WaitAsCompletion(nint Client, int Timeout);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_GetExecTime(nint Client, ref uint Time);
        public int ExecTime()
        {
            uint Time = new uint();
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_GetLastError(nint Client, ref int LastError);
        public int LastError()
        {
            int ClientLastError = new int();
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_GetPduLength(nint Client, ref int Requested, ref int Negotiated);

        public int RequestedPduLength()
        {
            int Requested = new int();
            int Negotiated = new int();
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_GetConnected(nint Client, ref uint IsConnected);
        public bool Connected()
        {
            uint IsConnected = new uint();
    ...
    public class S7Server
    {
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern nint Srv_Create();
        public S7Server()
        {
            Server = Srv_Create();
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Srv_Destroy(ref nint Server);
        ~S7Server()
        {
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Srv_StartTo(nint Server, [MarshalAs(UnmanagedType.LPStr)] string Address);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Srv_Start(nint Server);
        public int Start()
        {
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Srv_Stop(nint Server);
        public int Stop()
        {
        ...
        protected static extern int Srv_GetParam_i16(nint Server, int ParamNumber, ref short IntValue);
        public int GetParam(int ParamNumber, ref short IntValue)
        {
        ...
        [DllImport(S7Consts.Snap7LibName, EntryPoint = "Srv_GetParam")]
        protected static extern int Srv_GetParam_u16(nint Server, int ParamNumber, ref ushort IntValue);
        public int GetParam(int ParamNumber, ref ushort IntValue)
        {
        ...
        [DllImport(S7Consts.Snap7LibName, EntryPoint = "Srv_GetParam")]
        protected static extern int Srv_GetParam_i32(nint Server, int ParamNumber, ref int IntValue);
        public int GetParam(int ParamNumber, ref int IntValue)
        {
        ...
        [DllImport(S7Consts.Snap7LibName, EntryPoint = "Srv_GetParam")]
        protected static extern int Srv_GetParam_u32(nint Server, int ParamNumber, ref uint IntValue);
        public int GetParam(int ParamNumber, ref uint IntValue)
        {
        ...
        [DllImport(S7Consts.Snap7LibName, EntryPoint = "Srv_GetParam")]
        protected static extern int Srv_GetParam_i64(nint Server, int ParamNumber, ref long IntValue);
        public int GetParam(int ParamNumber, ref long IntValue)
        {
        ...
        [DllImport(S7Consts.Snap7LibName, EntryPoint = "Srv_GetParam")]
        protected static extern int Srv_GetParam_u64(nint Server, int ParamNumber, ref ulong IntValue);
        public int GetParam(int ParamNumber, ref ulong IntValue)
        {
        ...
        protected static extern int Srv_SetParam_i16(nint Server, int ParamNumber, ref short IntValue);
        public int SetParam(int ParamNumber, ref short IntValue)
        {
        ...
        [DllImport(S7Consts.Snap7LibName, EntryPoint = "Srv_SetParam")]
        protected static extern int Srv_SetParam_u16(nint Server, int ParamNumber, ref ushort IntValue);
        public int SetParam(int ParamNumber, ref ushort IntValue)
        {
        ...
        [DllImport(S7Consts.Snap7LibName, EntryPoint = "Srv_SetParam")]
        protected static extern int Srv_SetParam_i32(nint Server, int ParamNumber, ref int IntValue);
        public int SetParam(int ParamNumber, ref int IntValue)
        {
        ...
        [DllImport(S7Consts.Snap7LibName, EntryPoint = "Srv_SetParam")]
        protected static extern int Srv_SetParam_u32(nint Server, int ParamNumber, ref uint IntValue);
        public int SetParam(int ParamNumber, ref uint IntValue)
        {
        ...
        [DllImport(S7Consts.Snap7LibName, EntryPoint = "Srv_SetParam")]
        protected static extern int Srv_SetParam_i64(nint Server, int ParamNumber, ref long IntValue);
        public int SetParam(int ParamNumber, ref long IntValue)
        {
        ...
        [DllImport(S7Consts.Snap7LibName, EntryPoint = "Srv_SetParam")]
        protected static extern int Srv_SetParam_u64(nint Server, int ParamNumber, ref ulong IntValue);
        public int SetParam(int ParamNumber, ref ulong IntValue)
        {
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Srv_RegisterArea(nint Server, int AreaCode, int Index, nint pUsrData, int Size);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Srv_UnregisterArea(nint Server, int AreaCode, int Index);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Srv_LockArea(nint Server, int AreaCode, int Index);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Srv_UnlockArea(nint Server, int AreaCode, int Index);
        ...
        public delegate void TSrvCallback(nint usrPtr, ref USrvEvent Event, int Size);
        public delegate int TSrvRWAreaCallback(nint usrPtr, int Sender, int Operation, ref S7Consts.S7Tag Tag, ref RWBuffer Buffer);

        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Srv_SetEventsCallback(nint Server, TSrvCallback Callback, nint usrPtr);
        public int SetEventsCallBack(TSrvCallback Callback, nint usrPtr)
        {
            return Srv_SetEventsCallback(Server, Callback, usrPtr);
        }

        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Srv_SetReadEventsCallback(nint Server, TSrvCallback Callback, nint usrPtr);
        public int SetReadEventsCallBack(TSrvCallback Callback, nint usrPtr)
        {
            return Srv_SetReadEventsCallback(Server, Callback, usrPtr);
        }

        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Srv_SetRWAreaCallback(nint Server, TSrvRWAreaCallback Callback, nint usrPtr);
        public int SetRWAreaCallBack(TSrvRWAreaCallback Callback, nint usrPtr)
        {
            return Srv_SetRWAreaCallback(Server, Callback, usrPtr);
        }

        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Srv_PickEvent(nint Server, ref USrvEvent Event, ref int EvtReady);
        public bool PickEvent(ref USrvEvent Event)
        {
            int EvtReady = new int();
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Srv_ClearEvents(nint Server);
        ...
        public DateTime EvtTimeToDateTime(nint TimeStamp)
        {
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Srv_GetMask(nint Server, int MaskKind, ref uint Mask);
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Srv_SetMask(nint Server, int MaskKind, uint Mask);
        ...
        public uint LogMask
        {
            ...
            set
            {
                Srv_SetMask(Server, mkLog, value);
            }
        }
        ...
        public uint EventMask
        {
            ...
            set
            {
                Srv_SetMask(Server, mkEvent, value);
            }
        }
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Srv_GetStatus(nint Server, ref int ServerStatus, ref int CpuStatus, ref int ClientsCount);
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Srv_SetCpuStatus(nint Server, int CpuStatus);
    ...
    public class S7Partner
    {
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern nint Par_Create(int ParActive);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Par_Destroy(ref nint Partner);
        ~S7Partner()
        {
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Par_Start(nint Partner);
        public int Start()
        {
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Par_Stop(nint Partner);
        public int Stop()
        {
        ...
        protected static extern int Par_GetParam_i16(nint Partner, int ParamNumber, ref short IntValue);
        public int GetParam(int ParamNumber, ref short IntValue)
        {
        ...
        [DllImport(S7Consts.Snap7LibName, EntryPoint = "Par_GetParam")]
        protected static extern int Par_GetParam_u16(nint Partner, int ParamNumber, ref ushort IntValue);
        public int GetParam(int ParamNumber, ref ushort IntValue)
        {
        ...
        [DllImport(S7Consts.Snap7LibName, EntryPoint = "Par_GetParam")]
        protected static extern int Par_GetParam_i32(nint Partner, int ParamNumber, ref int IntValue);
        public int GetParam(int ParamNumber, ref int IntValue)
        {
        ...
        [DllImport(S7Consts.Snap7LibName, EntryPoint = "Par_GetParam")]
        protected static extern int Par_GetParam_u32(nint Partner, int ParamNumber, ref uint IntValue);
        public int GetParam(int ParamNumber, ref uint IntValue)
        {
        ...
        [DllImport(S7Consts.Snap7LibName, EntryPoint = "Par_GetParam")]
        protected static extern int Par_GetParam_i64(nint Partner, int ParamNumber, ref long IntValue);
        public int GetParam(int ParamNumber, ref long IntValue)
        {
        ...
        [DllImport(S7Consts.Snap7LibName, EntryPoint = "Par_GetParam")]
        protected static extern int Par_GetParam_u64(nint Partner, int ParamNumber, ref ulong IntValue);
        public int GetParam(int ParamNumber, ref ulong IntValue)
        {
        ...
        protected static extern int Par_SetParam_i16(nint Partner, int ParamNumber, ref short IntValue);
        public int SetParam(int ParamNumber, ref short IntValue)
        {
        ...
        [DllImport(S7Consts.Snap7LibName, EntryPoint = "Par_SetParam")]
        protected static extern int Par_SetParam_u16(nint Partner, int ParamNumber, ref ushort IntValue);
        public int SetParam(int ParamNumber, ref ushort IntValue)
        {
        ...
        [DllImport(S7Consts.Snap7LibName, EntryPoint = "Par_SetParam")]
        protected static extern int Par_SetParam_i32(nint Partner, int ParamNumber, ref int IntValue);
        public int SetParam(int ParamNumber, ref int IntValue)
        {
        ...
        [DllImport(S7Consts.Snap7LibName, EntryPoint = "Par_SetParam")]
        protected static extern int Par_SetParam_u32(nint Partner, int ParamNumber, ref uint IntValue);
        public int SetParam(int ParamNumber, ref uint IntValue)
        {
        ...
        [DllImport(S7Consts.Snap7LibName, EntryPoint = "Par_SetParam")]
        protected static extern int Par_SetParam_i64(nint Partner, int ParamNumber, ref long IntValue);
        public int SetParam(int ParamNumber, ref long IntValue)
        {
        ...
        [DllImport(S7Consts.Snap7LibName, EntryPoint = "Par_SetParam")]
        protected static extern int Par_SetParam_u64(nint Partner, int ParamNumber, ref ulong IntValue);
        public int SetParam(int ParamNumber, ref ulong IntValue)
        {
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Par_BSend(nint Partner, uint R_ID, byte[] Buffer, int Size);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Par_AsBSend(nint Partner, uint R_ID, byte[] Buffer, int Size);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Par_CheckAsBSendCompletion(nint Partner, ref int opResult);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Par_WaitAsBSendCompletion(nint Partner, int Timeout);
        public int WaitAsBSendCompletion(int Timeout)
        {
            return Par_WaitAsBSendCompletion(Partner, Timeout);
        }

        public delegate void S7ParSendCompletion(nint usrPtr, int opResult);

        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Par_SetSendCallback(nint Partner, S7ParSendCompletion Completion, nint usrPtr);
        public int SetSendCallBack(S7ParSendCompletion Completion, nint usrPtr)
        {
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Par_BRecv(nint Partner, ref uint R_ID, byte[] Buffer, ref int Size, uint Timeout);
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Par_CheckAsBRecvCompletion(nint Partner, ref int opResult, ref uint R_ID, byte[] Buffer, ref int Size);
        ...
        public delegate void S7ParRecvCallback(nint usrPtr, int opResult, uint R_ID, nint pData, int Size);

        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Par_SetRecvCallback(nint Partner, S7ParRecvCallback Callback, nint usrPtr);
        public int SetRecvCallback(S7ParRecvCallback Callback, nint usrPtr)
        {
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Par_GetLastError(nint Partner, ref int LastError);
        public int LastError(ref int LastError)
        {
            int PartnerLastError = new int();
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Par_GetStats(nint Partner, ref int BytesSent, ref int BytesRecv,
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Par_GetStatus(nint Partner, ref int Status);
